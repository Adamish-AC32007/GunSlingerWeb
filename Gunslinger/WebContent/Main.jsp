	...
	<div>
		...
		<table class="hovertable">
			...
			<%
				...
				Iterator <GunSlingerStore> iterator; iterator =
				lGun.iterator(); while (iterator.hasNext()) { GunSlingerStore gs =
				(GunSlingerStore) iterator.next(); %>
